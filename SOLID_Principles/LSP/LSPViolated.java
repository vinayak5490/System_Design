...
class SavingAccount implements Account{
    ...
    public void withdraw(double amount){
        if(balance >= amount){
            balance -= amount;
            System.out.println("Withdrawn: " + amount + " from Savings Account. New Balance: ");
        }else{
            System.out.println("Insufficient funds in Savings Account!0");
        }
    }
}
    ...
    public void processTransactions(){
        for(Account acc : accounts){
            ...
            try {
                ...
                System.out.println("Excdption: " + e.getMessage());
            }
        }
    }
}
